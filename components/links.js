...
const Links = ()=>{
  ...
  return(
    <>
      ...
      <Link href="" className={cn("hover:text-red-600", (path=='/schools'?"text-indigo-400":""))}>Schools</Link>
      <Link href="" className={cn("hover:text-red-600", (path=='/opportunities'?"text-indigo-400":""))}>Opportunities</Link>
