...
//insert new school
export const insertSchool = async(schoolName, schoolsAddress, schoolCity, schoolZip, schoolPhoto, schoolDesc) => {
...
export const updateSchool = async(id,schoolName, schoolsAddress, schoolCity, schoolZip, schoolPhoto, schoolDesc) => {
